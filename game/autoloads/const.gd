...
const BACKGROUND_HOME_REGULAR := "home_regular.png" # ph
const BACKGROUND_HOME_BEDROOM := "placeholder.png" # ph
const BACKGROUND_HOME_KITCHEN := "placeholder.png" # ph
const BACKGROUND_FIELD := "field/Field.tscn"
const BACKGROUND_TRAIN := "train/Train.tscn"
const BACKGROUND_CLERICANT_INTERROGATION_CHAMBER := "clericant_interrogation_chamber.png"
...
const BACKGROUND_TRAIN_YARD := "placeholder.png" # PH
const BACKGROUND_CITY := "placeholder.png" # PH
const BACKGROUND_HOME_REGULAR_NIGHT := "placeholder.png" # PH
const BACKGROUND_SPECTRA_APARTMENT := "spectra_apartment.png"
const BACKGROUND_RIVERBANK := "placeholder.png"

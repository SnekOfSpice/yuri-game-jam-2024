...
const BACKGROUND_AUTUMN := "autumn.png" # PH
const BACKGROUND_BENCH := "bench/bench_day.tscn" # PH
const BACKGROUND_BENCH_NIGHT := "bench/bench_night.tscn" # PH
const BACKGROUND_BENCH_PATHWAY := "placeholder.png" # PH
const BACKGROUND_BENCH_PATHWAY_NIGHT := "placeholder.png" # PH
const BACKGROUND_BUS_RIDE := "bus_ride.png" # ph
...
const MUSIC_BLOODLETTING := "Paradise_Found.mp3" # ph # can be grief?
...
const SFX_CLERICANT_PHONE := "340922__passairmangrace__phonehomerings_quiet_stereo_bip.wav" # PhoneHomeRings_Quiet_stereo_bip.wav by passAirmangrace -- https://freesound.org/s/340922/ -- License: Attribution 3.0
